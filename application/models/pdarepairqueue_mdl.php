...
class Pdarepairqueue_mdl extends CI_Model{
    #code
    function __construct(){
        parent:: __construct();		
    }
		
	function table_pdarepairqueue()
	{
		...
		*/
		...
		if($StartInsDate <> '' && $EndInsDate <> ''){
			if($sWhere == ''){
				$sWhere .= " WHERE ( Convert(VARCHAR(10),HandoverPdiToVq,101) >= Convert(Varchar(10),'$StartInsDate',101) 
							AND Convert(VARCHAR(10),HandoverPdiToVq,101) <= Convert(Varchar(10),'$EndInsDate',101) ) ";
			}
			else
			{
				$sWhere .= " AND ( Convert(VARCHAR(10),HandoverPdiToVq,101) >= Convert(Varchar(10),'$StartInsDate',101) 
							AND Convert(VARCHAR(10),HandoverPdiToVq,101) <= Convert(Varchar(10),'$EndInsDate',101) ) ";
			}
		}
		 ...
		 * Ordering
		*/
		$sOrder = " ORDER BY HandoverPdiToVq DESC";
