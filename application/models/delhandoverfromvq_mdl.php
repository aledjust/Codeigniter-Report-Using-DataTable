...
class Delhandoverfromvq_mdl extends CI_Model{
    #code
    function __construct(){
        parent:: __construct();		
    }
		
	function table_delhandoverfromvq()
	{
		...
		$sTable = "txdelhandoverfromvq";
		
		$sWhere = '';
		$repair = $_GET['qf'];
		if($repair == '1'){
			$sWhere = " WHERE Repair = '1'";
		}
		else if($repair == '0'){
			$sWhere = " WHERE Repair = '0'";
		}
		else {
			$sWhere = '';
		}
	...
	function ExportExcel()
	{
		...
		*/
		...
		$sQuery = "SELECT Model, FrmNo, Kode, Keterangan, Colour,
				   CASE WHEN Repair = '1' THEN 'YES' ELSE 'NO' END AS Repair,
				   Status, NrkVq, NrkDelivery, InspectionDate FROM $sTable $sWhere";
