...
?>
	<div class="span9">
		<div id="data1">
			...
			<div class="row-fluid">
				<div>
					<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered nowrap" id="list">
						<thead>
							<tr>
								<th>MODEL</th>
								<th>FRAME NUMBER</th>
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        var dTable = $('#list').dataTable({
            ...
            "sAjaxSource": "<?= base_url(); ?>getvqhandovertodel?qf=all&startInsDate=&endInsDate=",
			"oLanguage"  : {
				"sSearch" : "Search",
				"sInfoFiltered" : ""
			},
        ...
        $('#btnsrc').click(function(d) {
            ...
            var tarTab = "<?= base_url(); ?>getvqhandovertodel?qf=" + qF + "&startInsDate=" + startInsDate + "&endInsDate=" + endInsDate;				
...
<script>
	jq31(document).ready(function() {
		jq31('#btnExportExcel').click(function() {
			var qF = jq31('#drpStatusInspeksi  option:selected').val();
            ...
            var tarTab = "<?= base_url(); ?>exportvqhandovertodel?qf=" + qF + "&startInsDate=" + startInsDate + "&endInsDate=" + endInsDate + "&sSearch=" + sSearch;
