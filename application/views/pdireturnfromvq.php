...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        var dTable = $('#list').dataTable({
			...
			"sAjaxSource": "<?= base_url(); ?>getpdireturnfromvq?startInsDate=&endInsDate=",
			"oLanguage"  : {
				"sSearch" : "Search",
				"sInfoFiltered" : ""
			},
        ...
        $('#btnsrc').click(function(d) {
            ...
            var tarTab = "<?= base_url(); ?>getpdireturnfromvq?startInsDate=" + startInsDate + "&endInsDate=" + endInsDate;				
...
<script>
	jq31(document).ready(function() {
		jq31('#btnExportExcel').click(function() {
            ...
            var tarTab = "<?= base_url(); ?>exportpdireturnfromvq?startInsDate=" + startInsDate + "&endInsDate=" + endInsDate + "&sSearch=" + sSearch;
