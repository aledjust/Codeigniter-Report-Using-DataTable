	...
	<div class="span9">
		<div id="data1">
			...
			<form class="form-inline">
				<label class="dropdown">
					Repair status 
					<?= form_dropdown('drpStatusRepair', array('all' => 'ALL', '1' => 'YES', '0' => 'NO'), 'all','id=drpStatusRepair'); ?>					
				</label>
				<?= form_button('btnsrc', 'Search', array('id' => 'btnsrc', 'class' => 'btn')); ?>
				<?= form_button('btnExportExcel', 'Export to excel', array('id' => 'btnExportExcel', 'class' => 'btn', 'style' => 'margin-left:15px')); ?>
			</form>
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        var dTable = $('#list').dataTable({
            ...
            "sAjaxSource": "<?= base_url(); ?>getdelhandoverfromvq?qf=all&startInsDate=&endInsDate=",
			"oLanguage"  : {
				"sSearch" : "Search",
				"sInfoFiltered" : ""
			},
        ...
        $('#btnsrc').click(function(d) {
            var qF = $('#drpStatusRepair  option:selected').val();
            ...
            var tarTab = "<?= base_url(); ?>getdelhandoverfromvq?qf=" + qF + "&startInsDate=" + startInsDate + "&endInsDate=" + endInsDate;				
...
<script>
	jq31(document).ready(function() {
		jq31('#btnExportExcel').click(function() {
			var qF = jq31('#drpStatusRepair  option:selected').val();
            ...
            var tarTab = "<?= base_url(); ?>exportdelhandoverfromvq?qf=" + qF + "&startInsDate=" + startInsDate + "&endInsDate=" + endInsDate + "&sSearch=" + sSearch;
